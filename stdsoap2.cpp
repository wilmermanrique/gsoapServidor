...
#else
  if (soap_valid_socket(soap->master) || soap_valid_socket(soap->socket) || soap->os || true ) /* standalone application (socket) or CGI (stdin/out)? */ /*Forzar OK para usar con xinetd, DavidP 20171223*/
#endif
